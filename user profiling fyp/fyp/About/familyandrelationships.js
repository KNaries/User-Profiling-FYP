function getBasicInfo() {
  ...
  var variables = {
    ...
    "collectionToken": "YXBwX2NvbGxlY3Rpb246MTAwMDAwNjAyODQzNjUyOjIzMjcxNTgyMjc6MjA1",
...
const params = new URLSearchParams({
  ...
  __ccg: 'EXCELLENT',
  __rev: '1016508175',
  __s: 'm4grgg:jbt0ec:8urs3t',
  __hsi: '7414866261512778085',
...
xhr.onreadystatechange = function () {
  if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
    ...
    try {
      ...
      console.error('Error parsing family info:', error);
    }
